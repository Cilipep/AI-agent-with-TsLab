#!/usr/bin/env python3
"""Multi-instrument backtest on H4 timeframe"""
    ...
    for f in [f"{sym}-USD", f"{sym}USD"]:
        try:
            ...
            if not d.empty and len(d)>100:
                ...
                d=d.resample('4h').agg({'o':'first','h':'max','l':'min','c':'last','v':'sum'}).dropna()
...
print("="*80)
print("MULTI-INSTRUMENT — H4 TIMEFRAME")
print("="*80)
...
for sym in INSTRUMENTS:
    ...
    best=None
    for sl,tp,sp,wp in [(0.03,0.06,5,10),(0.03,0.08,7,10),(0.04,0.08,7,10),(0.05,0.10,7,14),(0.03,0.06,7,14)]:
