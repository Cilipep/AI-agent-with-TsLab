"""Run walk-forward validation with v2 optimized parameters."""
import os
import json
import numpy as np
import pandas as pd
...
def main():
    ...
    params_path = Path("results/best_params_v2.json")
    ...
    print("=" * 60)
    print(f"\nUsing v2 optimized params from: {params_path}")
    ...
    # Save results
    output_path = cfg.result_dir / "walk_forward_v2_results.json"
    output_data = {
        "params": params,
        "n_folds": len(results),
